...
def upgrade() -> None:
    ...
    op.add_column('letter', sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False))
    op.create_index(op.f('ix_letter_created_at'), 'letter', ['created_at'], unique=False)
    ...
    op.create_index(op.f('ix_response_created_at'), 'response', ['created_at'], unique=False)
