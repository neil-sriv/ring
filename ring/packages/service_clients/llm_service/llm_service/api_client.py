...
import llm_service.models
from llm_service import rest
from llm_service.api_response import ApiResponse
from llm_service.api_response import T as ApiResponseT
from llm_service.configuration import Configuration
from llm_service.exceptions import (
    ApiException,
    ApiValueError,
    BadRequestException,
    ForbiddenException,
...
class ApiClient:
    ...
    def deserialize(
        ...
        if content_type is None:
            ...
            r"^text\/[a-z.+-]+\s*(;|$)", content_type, re.IGNORECASE
        ):
            data = response_text
        else:
            raise ApiException(
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(llm_service.models, klass)
    ...
    def files_parameters(
        self,
        files: Dict[
            str, Union[str, bytes, List[str], List[bytes], Tuple[str, bytes]]
        ],
    ):
