...
CREATE TABLE public.image (
	id INT8 NOT NULL,
	media_type VARCHAR NOT NULL DEFAULT 'image':::STRING,
...
CREATE TABLE public.comment (
	...
	created_at TIMESTAMPTZ NOT NULL DEFAULT now():::TIMESTAMPTZ,
	CONSTRAINT comment_pkey PRIMARY KEY (id ASC),
	UNIQUE INDEX ix_comment_api_identifier (api_identifier ASC),
	INDEX ix_comment_author_id (author_id ASC),
	INDEX ix_comment_created_at (created_at ASC),
	INDEX ix_comment_id (id ASC),
	INDEX ix_comment_question_id (question_id ASC)
);
...
ALTER TABLE public.comment ADD CONSTRAINT comment_deleted_by_id_fkey FOREIGN KEY (deleted_by_id) REFERENCES public."user"(id);
ALTER TABLE public.comment ADD CONSTRAINT comment_question_id_fkey FOREIGN KEY (question_id) REFERENCES public.question(id);
...
ALTER TABLE public.comment VALIDATE CONSTRAINT comment_deleted_by_id_fkey;
ALTER TABLE public.comment VALIDATE CONSTRAINT comment_question_id_fkey;
