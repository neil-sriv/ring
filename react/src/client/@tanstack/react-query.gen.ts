...
export const generateQuestionQuestionsQuestionGeneratePostQueryKey = (options: Options<GenerateQuestionQuestionsQuestionGeneratePostData>) => [
    createQueryKey('generateQuestionQuestionsQuestionGeneratePost', options)
];

export const generateQuestionQuestionsQuestionGeneratePostOptions = (options: Options<GenerateQuestionQuestionsQuestionGeneratePostData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await generateQuestionQuestionsQuestionGeneratePost({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: generateQuestionQuestionsQuestionGeneratePostQueryKey(options)
    });
};

export const generateQuestionQuestionsQuestionGeneratePostMutation = (options?: Partial<Options<GenerateQuestionQuestionsQuestionGeneratePostData>>) => {
    const mutationOptions: UseMutationOptions<GenerateQuestionQuestionsQuestionGeneratePostResponse, AxiosError<GenerateQuestionQuestionsQuestionGeneratePostError>, Options<GenerateQuestionQuestionsQuestionGeneratePostData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await generateQuestionQuestionsQuestionGeneratePost({
                ...options,
                ...localOptions,
