...
export const rawSearchSearchSearchRawSearchGetQueryKey = (options: Options<RawSearchSearchSearchRawSearchGetData>) => [
    createQueryKey('rawSearchSearchSearchRawSearchGet', options)
];

export const rawSearchSearchSearchRawSearchGetOptions = (options: Options<RawSearchSearchSearchRawSearchGetData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await rawSearchSearchSearchRawSearchGet({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: rawSearchSearchSearchRawSearchGetQueryKey(options)
    });
};

export const performSearchSearchSearchSearchGetQueryKey = (options: Options<PerformSearchSearchSearchSearchGetData>) => [
    createQueryKey('performSearchSearchSearchSearchGet', options)
];

export const performSearchSearchSearchSearchGetOptions = (options: Options<PerformSearchSearchSearchSearchGetData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await performSearchSearchSearchSearchGet({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: performSearchSearchSearchSearchGetQueryKey(options)
    });
};
