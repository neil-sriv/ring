...
export const replaceGroupResponderAllowlistPartiesGroupGroupApiIdReplaceResponderAllowlistPostQueryKey = (options: Options<ReplaceGroupResponderAllowlistPartiesGroupGroupApiIdReplaceResponderAllowlistPostData>) => [
    createQueryKey('replaceGroupResponderAllowlistPartiesGroupGroupApiIdReplaceResponderAllowlistPost', options)
];

export const replaceGroupResponderAllowlistPartiesGroupGroupApiIdReplaceResponderAllowlistPostOptions = (options: Options<ReplaceGroupResponderAllowlistPartiesGroupGroupApiIdReplaceResponderAllowlistPostData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await replaceGroupResponderAllowlistPartiesGroupGroupApiIdReplaceResponderAllowlistPost({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: replaceGroupResponderAllowlistPartiesGroupGroupApiIdReplaceResponderAllowlistPostQueryKey(options)
    });
};

export const replaceGroupResponderAllowlistPartiesGroupGroupApiIdReplaceResponderAllowlistPostMutation = (options?: Partial<Options<ReplaceGroupResponderAllowlistPartiesGroupGroupApiIdReplaceResponderAllowlistPostData>>) => {
    const mutationOptions: UseMutationOptions<ReplaceGroupResponderAllowlistPartiesGroupGroupApiIdReplaceResponderAllowlistPostResponse, AxiosError<ReplaceGroupResponderAllowlistPartiesGroupGroupApiIdReplaceResponderAllowlistPostError>, Options<ReplaceGroupResponderAllowlistPartiesGroupGroupApiIdReplaceResponderAllowlistPostData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await replaceGroupResponderAllowlistPartiesGroupGroupApiIdReplaceResponderAllowlistPost({
                ...options,
                ...localOptions,
...
export const replaceLetterResponderAllowlistLettersLetterLetterApiIdReplaceResponderAllowlistPostQueryKey = (options: Options<ReplaceLetterResponderAllowlistLettersLetterLetterApiIdReplaceResponderAllowlistPostData>) => [
    createQueryKey('replaceLetterResponderAllowlistLettersLetterLetterApiIdReplaceResponderAllowlistPost', options)
];

export const replaceLetterResponderAllowlistLettersLetterLetterApiIdReplaceResponderAllowlistPostOptions = (options: Options<ReplaceLetterResponderAllowlistLettersLetterLetterApiIdReplaceResponderAllowlistPostData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await replaceLetterResponderAllowlistLettersLetterLetterApiIdReplaceResponderAllowlistPost({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: replaceLetterResponderAllowlistLettersLetterLetterApiIdReplaceResponderAllowlistPostQueryKey(options)
    });
};

export const replaceLetterResponderAllowlistLettersLetterLetterApiIdReplaceResponderAllowlistPostMutation = (options?: Partial<Options<ReplaceLetterResponderAllowlistLettersLetterLetterApiIdReplaceResponderAllowlistPostData>>) => {
    const mutationOptions: UseMutationOptions<ReplaceLetterResponderAllowlistLettersLetterLetterApiIdReplaceResponderAllowlistPostResponse, AxiosError<ReplaceLetterResponderAllowlistLettersLetterLetterApiIdReplaceResponderAllowlistPostError>, Options<ReplaceLetterResponderAllowlistLettersLetterLetterApiIdReplaceResponderAllowlistPostData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await replaceLetterResponderAllowlistLettersLetterLetterApiIdReplaceResponderAllowlistPost({
                ...options,
                ...localOptions,
