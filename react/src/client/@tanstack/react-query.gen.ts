...
export const bulkEditResponsesLettersLetterLetterApiIdBulkEditResponsesPatchMutation = (options?: Partial<Options<BulkEditResponsesLettersLetterLetterApiIdBulkEditResponsesPatchData>>) => {
    const mutationOptions: UseMutationOptions<BulkEditResponsesLettersLetterLetterApiIdBulkEditResponsesPatchResponse, AxiosError<BulkEditResponsesLettersLetterLetterApiIdBulkEditResponsesPatchError>, Options<BulkEditResponsesLettersLetterLetterApiIdBulkEditResponsesPatchData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await bulkEditResponsesLettersLetterLetterApiIdBulkEditResponsesPatch({
                ...options,
                ...localOptions,
                throwOnError: true
            });
