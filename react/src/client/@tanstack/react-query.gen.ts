...
export const setGroupDesignatedRespondersPartiesGroupGroupApiIdSetDesignatedRespondersPostMutation = (options?: Partial<Options<SetGroupDesignatedRespondersPartiesGroupGroupApiIdSetDesignatedRespondersPostData>>) => {
    const mutationOptions: UseMutationOptions<SetGroupDesignatedRespondersPartiesGroupGroupApiIdSetDesignatedRespondersPostResponse, AxiosError<SetGroupDesignatedRespondersPartiesGroupGroupApiIdSetDesignatedRespondersPostError>, Options<SetGroupDesignatedRespondersPartiesGroupGroupApiIdSetDesignatedRespondersPostData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await setGroupDesignatedRespondersPartiesGroupGroupApiIdSetDesignatedRespondersPost({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const setLetterDesignatedRespondersLettersLetterLetterApiIdSetDesignatedRespondersPostMutation = (options?: Partial<Options<SetLetterDesignatedRespondersLettersLetterLetterApiIdSetDesignatedRespondersPostData>>) => {
    const mutationOptions: UseMutationOptions<SetLetterDesignatedRespondersLettersLetterLetterApiIdSetDesignatedRespondersPostResponse, AxiosError<SetLetterDesignatedRespondersLettersLetterLetterApiIdSetDesignatedRespondersPostError>, Options<SetLetterDesignatedRespondersLettersLetterLetterApiIdSetDesignatedRespondersPostData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await setLetterDesignatedRespondersLettersLetterLetterApiIdSetDesignatedRespondersPost({
                ...options,
                ...localOptions,
                throwOnError: true
            });
