...
export const updateUserAdminPartiesUserIdAdminPatchMutation = (options?: Partial<Options<UpdateUserAdminPartiesUserIdAdminPatchData>>) => {
    const mutationOptions: UseMutationOptions<UpdateUserAdminPartiesUserIdAdminPatchResponse, AxiosError<UpdateUserAdminPartiesUserIdAdminPatchError>, Options<UpdateUserAdminPartiesUserIdAdminPatchData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await updateUserAdminPartiesUserIdAdminPatch({
                ...options,
                ...localOptions,
                throwOnError: true
            });
