...
export const getShareLinkSharesGetQueryKey = (options: Options<GetShareLinkSharesGetData>) => [
    createQueryKey('getShareLinkSharesGet', options)
];

export const getShareLinkSharesGetOptions = (options: Options<GetShareLinkSharesGetData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getShareLinkSharesGet({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getShareLinkSharesGetQueryKey(options)
    });
};

export const createShareLinkSharesPostQueryKey = (options: Options<CreateShareLinkSharesPostData>) => [
    createQueryKey('createShareLinkSharesPost', options)
];

export const createShareLinkSharesPostOptions = (options: Options<CreateShareLinkSharesPostData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await createShareLinkSharesPost({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: createShareLinkSharesPostQueryKey(options)
    });
};

export const createShareLinkSharesPostMutation = (options?: Partial<Options<CreateShareLinkSharesPostData>>) => {
    const mutationOptions: UseMutationOptions<CreateShareLinkSharesPostResponse, AxiosError<CreateShareLinkSharesPostError>, Options<CreateShareLinkSharesPostData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createShareLinkSharesPost({
                ...options,
                ...localOptions,
...
export const revokeShareLinkSharesTokenDeleteMutation = (options?: Partial<Options<RevokeShareLinkSharesTokenDeleteData>>) => {
    const mutationOptions: UseMutationOptions<RevokeShareLinkSharesTokenDeleteResponse, AxiosError<RevokeShareLinkSharesTokenDeleteError>, Options<RevokeShareLinkSharesTokenDeleteData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await revokeShareLinkSharesTokenDelete({
                ...options,
                ...localOptions,
                throwOnError: true
            });
