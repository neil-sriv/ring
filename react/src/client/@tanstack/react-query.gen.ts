...
export const createShortLinkLinksShortLinkPostQueryKey = (options: Options<CreateShortLinkLinksShortLinkPostData>) => [
    createQueryKey('createShortLinkLinksShortLinkPost', options)
];

export const createShortLinkLinksShortLinkPostOptions = (options: Options<CreateShortLinkLinksShortLinkPostData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await createShortLinkLinksShortLinkPost({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: createShortLinkLinksShortLinkPostQueryKey(options)
    });
};

export const createShortLinkLinksShortLinkPostMutation = (options?: Partial<Options<CreateShortLinkLinksShortLinkPostData>>) => {
    const mutationOptions: UseMutationOptions<CreateShortLinkLinksShortLinkPostResponse, AxiosError<CreateShortLinkLinksShortLinkPostError>, Options<CreateShortLinkLinksShortLinkPostData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createShortLinkLinksShortLinkPost({
                ...options,
                ...localOptions,
...
export const resolveShortLinkLinksShortLinkTokenGetQueryKey = (options: Options<ResolveShortLinkLinksShortLinkTokenGetData>) => [
    createQueryKey('resolveShortLinkLinksShortLinkTokenGet', options)
];

export const resolveShortLinkLinksShortLinkTokenGetOptions = (options: Options<ResolveShortLinkLinksShortLinkTokenGetData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await resolveShortLinkLinksShortLinkTokenGet({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: resolveShortLinkLinksShortLinkTokenGetQueryKey(options)
    });
};

export const deleteShortLinkLinksShortLinkShortLinkApiIdDeleteMutation = (options?: Partial<Options<DeleteShortLinkLinksShortLinkShortLinkApiIdDeleteData>>) => {
    const mutationOptions: UseMutationOptions<DeleteShortLinkLinksShortLinkShortLinkApiIdDeleteResponse, AxiosError<DeleteShortLinkLinksShortLinkShortLinkApiIdDeleteError>, Options<DeleteShortLinkLinksShortLinkShortLinkApiIdDeleteData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await deleteShortLinkLinksShortLinkShortLinkApiIdDelete({
                ...options,
                ...localOptions,
                throwOnError: true
            });
