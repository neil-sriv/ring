 ...
 */
export const getShareLinkSharesGet = <ThrowOnError extends boolean = false>(options: Options<GetShareLinkSharesGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetShareLinkSharesGetResponse, GetShareLinkSharesGetError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const createShareLinkSharesPost = <ThrowOnError extends boolean = false>(options: Options<CreateShareLinkSharesPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CreateShareLinkSharesPostResponse, CreateShareLinkSharesPostError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const revokeShareLinkSharesTokenDelete = <ThrowOnError extends boolean = false>(options: Options<RevokeShareLinkSharesTokenDeleteData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<RevokeShareLinkSharesTokenDeleteResponse, RevokeShareLinkSharesTokenDeleteError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
