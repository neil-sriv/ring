 ...
 * Generate a question using LLM without saving it.
 */
export const generateQuestionQuestionsQuestionGeneratePost = <ThrowOnError extends boolean = false>(options: Options<GenerateQuestionQuestionsQuestionGeneratePostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<GenerateQuestionQuestionsQuestionGeneratePostResponse, GenerateQuestionQuestionsQuestionGeneratePostError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
