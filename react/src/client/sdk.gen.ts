 ...
 */
export const updateUserAdminPartiesUserIdAdminPatch = <ThrowOnError extends boolean = false>(options: Options<UpdateUserAdminPartiesUserIdAdminPatchData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<UpdateUserAdminPartiesUserIdAdminPatchResponse, UpdateUserAdminPartiesUserIdAdminPatchError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
