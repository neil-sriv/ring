 ...
 */
export const listNotificationsNotificationsGet = <ThrowOnError extends boolean = false>(options?: Options<ListNotificationsNotificationsGetData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ListNotificationsNotificationsGetResponse, ListNotificationsNotificationsGetError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const getUnreadCountNotificationsUnreadCountGet = <ThrowOnError extends boolean = false>(options?: Options<GetUnreadCountNotificationsUnreadCountGetData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetUnreadCountNotificationsUnreadCountGetResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const markNotificationReadNotificationsNotificationApiIdReadPost = <ThrowOnError extends boolean = false>(options: Options<MarkNotificationReadNotificationsNotificationApiIdReadPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<MarkNotificationReadNotificationsNotificationApiIdReadPostResponse, MarkNotificationReadNotificationsNotificationApiIdReadPostError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 * PermissionError: If the notification belongs to another user
 */
export const markNotificationUnreadNotificationsNotificationApiIdUnreadPost = <ThrowOnError extends boolean = false>(options: Options<MarkNotificationUnreadNotificationsNotificationApiIdUnreadPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<MarkNotificationUnreadNotificationsNotificationApiIdUnreadPostResponse, MarkNotificationUnreadNotificationsNotificationApiIdUnreadPostError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const markAllNotificationsReadNotificationsReadAllPost = <ThrowOnError extends boolean = false>(options?: Options<MarkAllNotificationsReadNotificationsReadAllPostData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<MarkAllNotificationsReadNotificationsReadAllPostResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 * PermissionError: If the notification belongs to another user
 */
export const deleteNotificationNotificationsNotificationApiIdDelete = <ThrowOnError extends boolean = false>(options: Options<DeleteNotificationNotificationsNotificationApiIdDeleteData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteNotificationNotificationsNotificationApiIdDeleteResponse, DeleteNotificationNotificationsNotificationApiIdDeleteError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
