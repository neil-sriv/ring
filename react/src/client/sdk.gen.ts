 ...
 */
export const rawSearchSearchSearchRawSearchGet = <ThrowOnError extends boolean = false>(options: Options<RawSearchSearchSearchRawSearchGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<RawSearchSearchSearchRawSearchGetResponse, RawSearchSearchSearchRawSearchGetError, ThrowOnError>({
 ...
 * Perform Search
 */
export const performSearchSearchSearchSearchGet = <ThrowOnError extends boolean = false>(options: Options<PerformSearchSearchSearchSearchGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<PerformSearchSearchSearchSearchGetResponse, PerformSearchSearchSearchSearchGetError, ThrowOnError>({
