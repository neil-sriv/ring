 ...
 */
export const createShortLinkLinksShortLinkPost = <ThrowOnError extends boolean = false>(options: Options<CreateShortLinkLinksShortLinkPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CreateShortLinkLinksShortLinkPostResponse, CreateShortLinkLinksShortLinkPostError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const resolveShortLinkLinksShortLinkTokenGet = <ThrowOnError extends boolean = false>(options: Options<ResolveShortLinkLinksShortLinkTokenGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ResolveShortLinkLinksShortLinkTokenGetResponse, ResolveShortLinkLinksShortLinkTokenGetError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const deleteShortLinkLinksShortLinkShortLinkApiIdDelete = <ThrowOnError extends boolean = false>(options: Options<DeleteShortLinkLinksShortLinkShortLinkApiIdDeleteData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteShortLinkLinksShortLinkShortLinkApiIdDeleteResponse, DeleteShortLinkLinksShortLinkShortLinkApiIdDeleteError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
