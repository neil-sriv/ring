...
export const setGroupDesignatedRespondersPartiesGroupGroupApiIdSetDesignatedRespondersPost = <ThrowOnError extends boolean = false>(options: Options<SetGroupDesignatedRespondersPartiesGroupGroupApiIdSetDesignatedRespondersPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<SetGroupDesignatedRespondersPartiesGroupGroupApiIdSetDesignatedRespondersPostResponse, SetGroupDesignatedRespondersPartiesGroupGroupApiIdSetDesignatedRespondersPostError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const setLetterDesignatedRespondersLettersLetterLetterApiIdSetDesignatedRespondersPost = <ThrowOnError extends boolean = false>(options: Options<SetLetterDesignatedRespondersLettersLetterLetterApiIdSetDesignatedRespondersPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<SetLetterDesignatedRespondersLettersLetterLetterApiIdSetDesignatedRespondersPostResponse, SetLetterDesignatedRespondersLettersLetterLetterApiIdSetDesignatedRespondersPostError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
