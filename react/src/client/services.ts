...
export class LoginService {
   ...
   * @throws ApiError
   */
  public static resetPasswordRequestResetPasswordRequestEmailPost(
    data: LoginData["ResetPasswordRequestResetPasswordRequestEmailPost"]
   ...
   * @throws ApiError
   */
  public static resetPasswordResetPasswordTokenPost(
    data: LoginData["ResetPasswordResetPasswordTokenPost"]
  ): CancelablePromise<ResponseMessage> {
   ...
   * @throws ApiError
   */
  public static recoverPasswordHtmlContentPasswordRecoveryHtmlContentEmailPost(
    data: LoginData["RecoverPasswordHtmlContentPasswordRecoveryHtmlContentEmailPost"]
...
export class PartiesService {
   ...
   * @throws ApiError
   */
  public static updateUserMePartiesMePatch(
    data: PartiesData["UpdateUserMePartiesMePatch"]
  ): CancelablePromise<UserLinked> {
   ...
   * @throws ApiError
   */
  public static createUserPartiesUserPost(
    data: PartiesData["CreateUserPartiesUserPost"]
  ): CancelablePromise<UserLinked> {
    const { requestBody } = data;
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static registerUserPartiesRegisterTokenPost(
   ...
   * @throws ApiError
   */
  public static readUsersPartiesUsersGet(
    data: PartiesData["ReadUsersPartiesUsersGet"] = {}
  ): CancelablePromise<Array<UserLinked>> {
   ...
   * @throws ApiError
   */
  public static readUserByIdPartiesUserUserApiIdGet(
    data: PartiesData["ReadUserByIdPartiesUserUserApiIdGet"]
  ): CancelablePromise<UserLinked> {
   ...
   * @throws ApiError
   */
  public static updatePasswordMePartiesMePasswordPatch(
    data: PartiesData["UpdatePasswordMePartiesMePasswordPatch"]
  ): CancelablePromise<ResponseMessage> {
    const { requestBody } = data;
    return __request(OpenAPI, {
      method: "PATCH",
   ...
   * @throws ApiError
   */
  public static createGroupPartiesGroupPost(
    data: PartiesData["CreateGroupPartiesGroupPost"]
  ): CancelablePromise<GroupLinked> {
    const { requestBody } = data;
    return __request(OpenAPI, {
      method: "POST",
      url: "/parties/group",
   ...
   * @throws ApiError
   */
  public static listGroupsPartiesGroupsGet(
    data: PartiesData["ListGroupsPartiesGroupsGet"]
  ): CancelablePromise<Array<GroupLinked>> {
    const { userApiId, skip = 0, limit = 100 } = data;
    return __request(OpenAPI, {
      method: "GET",
      url: "/parties/groups/",
      query: {
   ...
   * @throws ApiError
   */
  public static readGroupPartiesGroupGroupApiIdGet(
    data: PartiesData["ReadGroupPartiesGroupGroupApiIdGet"]
  ): CancelablePromise<GroupLinked> {
    const { groupApiId } = data;
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static updateGroupPartiesGroupGroupApiIdPatch(
    data: PartiesData["UpdateGroupPartiesGroupGroupApiIdPatch"]
  ): CancelablePromise<GroupLinked> {
    const { groupApiId, requestBody } = data;
    return __request(OpenAPI, {
      method: "PATCH",
      url: "/parties/group/{group_api_id}",
      path: {
   ...
   * @throws ApiError
   */
  public static addUserToGroupPartiesGroupGroupApiIdAddMemberUserApiIdPost(
    data: PartiesData["AddUserToGroupPartiesGroupGroupApiIdAddMemberUserApiIdPost"]
  ): CancelablePromise<GroupLinked> {
    const { groupApiId, userApiId } = data;
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static removeUserFromGroupPartiesGroupGroupApiIdRemoveMemberUserApiIdPost(
    data: PartiesData["RemoveUserFromGroupPartiesGroupGroupApiIdRemoveMemberUserApiIdPost"]
  ): CancelablePromise<GroupLinked> {
    const { groupApiId, userApiId } = data;
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static scheduleSendPartiesGroupGroupApiIdScheduleSendPost(
    data: PartiesData["ScheduleSendPartiesGroupGroupApiIdScheduleSendPost"]
  ): CancelablePromise<GroupLinked> {
    const { groupApiId, requestBody } = data;
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static addMembersPartiesGroupGroupApiIdAddMembersPost(
    data: PartiesData["AddMembersPartiesGroupGroupApiIdAddMembersPost"]
  ): CancelablePromise<GroupLinked> {
    const { groupApiId, requestBody } = data;
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static replaceGroupDefaultQuestionsPartiesGroupGroupApiIdReplaceDefaultQuestionsPost(
    data: PartiesData["ReplaceGroupDefaultQuestionsPartiesGroupGroupApiIdReplaceDefaultQuestionsPost"]
  ): CancelablePromise<GroupLinked> {
    const { groupApiId, requestBody } = data;
    return __request(OpenAPI, {
      method: "POST",
...
export class LettersService {
   ...
   * @throws ApiError
   */
  public static addNextLetterLettersLetterPost(
    data: LettersData["AddNextLetterLettersLetterPost"]
  ): CancelablePromise<PublicLetter> {
    const { requestBody } = data;
    return __request(OpenAPI, {
      method: "POST",
      url: "/letters/letter",
   ...
   * @throws ApiError
   */
  public static listLettersLettersLettersGet(
    data: LettersData["ListLettersLettersLettersGet"]
  ): CancelablePromise<Array<PublicLetter>> {
    const { groupApiId, skip = 0, limit = 100 } = data;
    return __request(OpenAPI, {
      method: "GET",
      url: "/letters/letters/",
      query: {
   ...
   * @throws ApiError
   */
  public static readLetterLettersLetterLetterApiIdGet(
    data: LettersData["ReadLetterLettersLetterLetterApiIdGet"]
  ): CancelablePromise<PublicLetter> {
    const { letterApiId } = data;
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static editLetterLettersLetterLetterApiIdEditLetterPost(
    data: LettersData["EditLetterLettersLetterLetterApiIdEditLetterPost"]
  ): CancelablePromise<PublicLetter> {
    const { letterApiId, requestBody } = data;
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static addQuestionLettersLetterLetterApiIdAddQuestionPost(
    data: LettersData["AddQuestionLettersLetterLetterApiIdAddQuestionPost"]
  ): CancelablePromise<PublicLetter> {
    const { letterApiId, requestBody } = data;
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static bulkEditResponsesLettersLetterLetterApiIdBulkEditResponsesPatch(
    data: LettersData["BulkEditResponsesLettersLetterLetterApiIdBulkEditResponsesPatch"]
  ): CancelablePromise<PublicLetter> {
    const { letterApiId, requestBody } = data;
    return __request(OpenAPI, {
      method: "PATCH",
...
export class ScheduleService {
   ...
   * @throws ApiError
   */
  public static getScheduleForGroupScheduleScheduleGroupApiIdGet(
    data: ScheduleData["GetScheduleForGroupScheduleScheduleGroupApiIdGet"]
  ): CancelablePromise<ScheduleLinked> {
    const { groupApiId } = data;
    return __request(OpenAPI, {
      method: "GET",
...
export class QuestionsService {
   ...
   * @throws ApiError
   */
  public static upsertResponseQuestionsQuestionQuestionApiIdUpsertResponsePost(
    data: QuestionsData["UpsertResponseQuestionsQuestionQuestionApiIdUpsertResponsePost"]
  ): CancelablePromise<QuestionLinked> {
    const { questionApiId, requestBody } = data;
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static uploadImageQuestionsQuestionQuestionApiIdUploadImagePost(
    data: QuestionsData["UploadImageQuestionsQuestionQuestionApiIdUploadImagePost"]
  ): CancelablePromise<QuestionLinked> {
    const { questionApiId, formData } = data;
    return __request(OpenAPI, {
      method: "POST",
...
export class ResponsesService {
   ...
   * @throws ApiError
   */
  public static editResponseResponsesResponseResponseApiIdEditResponsePost(
    data: ResponsesData["EditResponseResponsesResponseResponseApiIdEditResponsePost"]
  ): CancelablePromise<ResponseLinked> {
    const { responseApiId, requestBody } = data;
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static uploadImageResponsesResponseResponseApiIdUploadImagePost(
    data: ResponsesData["UploadImageResponsesResponseResponseApiIdUploadImagePost"]
  ): CancelablePromise<ResponseLinked> {
    const { responseApiId, formData } = data;
    return __request(OpenAPI, {
      method: "POST",
...
export class InvitesService {
  ...
  public static createInviteInvitesPost(
    data: InvitesData["CreateInviteInvitesPost"]
  ): CancelablePromise<InviteLinked> {
    const { requestBody } = data;
    return __request(OpenAPI, {
      method: "POST",
      url: "/invites/",
   ...
   * @throws ApiError
   */
  public static validateTokenInvitesTokenTokenGet(
    data: InvitesData["ValidateTokenInvitesTokenTokenGet"]
  ): CancelablePromise<InviteLinked> {
    const { token } = data;
    return __request(OpenAPI, {
      method: "GET",
