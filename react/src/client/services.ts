...
export class LoginService {
  ...
  public static recoverPassword(
    ...
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/v1/internal/password-recovery/{email}",
      path: {
        email,
      },
      errors: {
  ...
  public static resetPassword(
    ...
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/v1/internal/reset-password/",
      body: requestBody,
  ...
  public static recoverPasswordHtmlContent(
    ...
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/v1/internal/password-recovery-html-content/{email}",
      path: {
        email,
      },
      errors: {
...
export class UsersService {
  ...
  public static updatePasswordMe(
    ...
    return __request(OpenAPI, {
      method: "PATCH",
      url: "/api/v1/internal/users/me/password",
      body: requestBody,
      mediaType: "application/json",
      errors: {
        422: `Validation Error`,
  ...
  public static registerUser(
    ...
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/v1/internal/users/signup",
      body: requestBody,
      mediaType: "application/json",
      errors: {
        422: `Validation Error`,
  ...
  public static readUserById(
    ...
    return __request(OpenAPI, {
      method: "GET",
      url: "/api/v1/internal/users/{user_id}",
      path: {
        user_id: userId,
      },
      errors: {
...
export class UtilsService {
  ...
  public static testEmail(data: TDataTestEmail): CancelablePromise<Message> {
    ...
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/v1/internal/utils/test-email/",
      query: {
        email_to: emailTo,
      },
      errors: {
