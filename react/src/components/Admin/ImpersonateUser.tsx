...
import { ImpersonateUserTokenImpersonateUserTokenPostError, Token, type UserLinked } from "../../client";
...
const ImpersonateUser = ({ user, isOpen, onClose }: ImpersonateUserProps) => {
    ...
    const mutation = useMutation({
        ...
        onError: (err: AxiosError<ImpersonateUserTokenImpersonateUserTokenPostError>) => {
            const errDetail =
