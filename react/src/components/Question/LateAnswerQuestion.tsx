import { Box, Button, Heading, Textarea, useColorModeValue } from "@chakra-ui/react";
...
import {
    ...
    UpsertResponseQuestionsQuestionQuestionApiIdUpsertResponsePostError,
    UserLinked,
} from "../../client";
import {
...
function LateAnswerQuestion({
    ...
    const mutation = useMutation({
        ...
        onError: (err: AxiosError<UpsertResponseQuestionsQuestionQuestionApiIdUpsertResponsePostError>) => {
            const errDetail =
                err.response?.data.detail || "Failed to submit late answer. Please try again.";
